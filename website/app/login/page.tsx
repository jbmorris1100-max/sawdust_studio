...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    // Auth wired via Supabase — endpoint pending
          ...
          <div style={{ width: '100%', maxWidth: 420 }}>
            ...
            <div style={{
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                ...
                <div className="form-field">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                    ...
                    <a href="#" style={{ fontSize: 12, color: 'var(--teal-dim)', transition: 'color 0.15s' }}>Forgot password?</a>
                  </div>
                  <input
                    id="password"
                    className="form-input"
              ...
              <p style={{ textAlign: 'center', fontSize: 13, color: 'var(--ink-mute)', marginTop: 4 }}>
                No account?{' '}
                <Link href="/signup" style={{ color: 'var(--teal)', fontWeight: 600 }}>
                  Start free trial
                </Link>
              </p>
            </div>
